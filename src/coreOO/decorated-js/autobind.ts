...
const getOwnKeys = getOwnPropertySymbols
  ? function (object) {
      return getOwnPropertyNames(object).concat(getOwnPropertySymbols(object) as any)
    }
  : getOwnPropertyNames

export function createDefaultSetter(key) {
  return function set(this: any, newValue) {
...
const autobind: ClassDecorator = (...args) => {
